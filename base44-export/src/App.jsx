...
const typographyDefaults = {
  section: { font: 'inter', size: 'balanced', weight: 'regular' },
  feature: { font: 'inter', size: 'balanced', weight: 'regular' },
  card: { font: 'inter', size: 'balanced', weight: 'regular' },
  small: { font: 'plex', size: 'balanced', weight: 'regular' },
  meta: { font: 'plex', size: 'balanced', weight: 'regular' },
  body: { font: 'inter', size: 'balanced', weight: 'regular' },
  menu: { font: 'plex', size: 'balanced', weight: 'regular' },
